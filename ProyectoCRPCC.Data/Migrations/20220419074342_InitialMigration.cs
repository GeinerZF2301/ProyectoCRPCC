        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Empleado_Sucursales_SucursalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServicioDetalles_Productos_IdProducto",
                        column: x => x.IdProducto,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServicioDetalles_Servicios_IdServicio",
                        column: x => x.IdServicio,
                        principalTable: "Servicios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServicioDetalles_Sucursales_IdSucursal",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiciosClientes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiciosClientes_Clientes_IdCliente",
            ...
            migrationBuilder.CreateTable(
                name: "ServiciosClienteDetalles",
                columns: table => new
                {
                    IdServiciosClienteDetalle = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Precio = table.Column<double>(type: "float", nullable: false),
                    Cantidad = table.Column<int>(type: "int", nullable: false),
                    IdServiciosCliente = table.Column<int>(type: "int", nullable: false),
                    IdProducto = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiciosClienteDetalles", x => x.IdServiciosClienteDetalle);
                    table.ForeignKey(
                        name: "FK_ServiciosClienteDetalles_Productos_IdProducto",
                        column: x => x.IdProducto,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiciosClienteDetalles_ServiciosClientes_IdServiciosCliente",
                        column: x => x.IdServiciosCliente,
                        principalTable: "ServiciosClientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicioDetalles_IdProducto",
                table: "ServicioDetalles",
                column: "IdProducto");

            migrationBuilder.CreateIndex(
                name: "IX_ServicioDetalles_IdServicio",
                table: "ServicioDetalles",
                column: "IdServicio");

            migrationBuilder.CreateIndex(
                name: "IX_ServicioDetalles_IdSucursal",
                table: "ServicioDetalles",
                column: "IdSucursal");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiciosClienteDetalles_IdProducto",
                table: "ServiciosClienteDetalles",
                column: "IdProducto");

            migrationBuilder.CreateIndex(
                name: "IX_ServiciosClienteDetalles_IdServiciosCliente",
                table: "ServiciosClienteDetalles",
                column: "IdServiciosCliente");

            migrationBuilder.CreateIndex(
                name: "IX_ServiciosClientes_IdCliente",
                table: "ServiciosClientes",
                column: "IdCliente");
        }
